# DEPRECATED: This script name is misleading. Use run_ablation_no_nli_filtering.py instead.
# In the paper, "w/o Re-retrieval" refers to the variant that omits NLI filtering
# (not the variant that shares retrieval context). See run_ablation_no_nli_filtering.py
# for the paper-aligned version.
#
# Original behavior: all perturbations receive the SAME document set as the
# original query (shared context), isolating re-retrieval contribution.
#
